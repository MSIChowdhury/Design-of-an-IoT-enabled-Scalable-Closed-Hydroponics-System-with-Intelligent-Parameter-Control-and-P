...
while True:
    try:
        ...
        s_bytes = actuation.readline().decode('utf-8')
        if s_bytes:
            decoded_bytes = s_bytes.strip("\n\r")
        ...
        s_bytes_sensing = sensing.readline().decode("utf-8")
        if s_bytes_sensing:
            decoded_bytes_sensing = s_bytes_sensing.strip("\n\r")
