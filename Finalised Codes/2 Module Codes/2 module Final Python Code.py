...
# All pH Flags
pHCheck = True
pHCheckInterval = 20 * 60  # Seconds

# All EC Flags
ECCheck = True
ECCheckInterval = 20 * 60  # Seconds
...
LightSwitchOffDuration = 6 * (60 * 60)
...
def printSensor():
    ...
    print("------- MODULE 1 --------")
    print("CO2: ", CO2, "PPM")
    print("Air Temperature: ", round(Air_temperature_1, 2), " Celsius")
    print("Humidity: ", Humidity_1, "%")
    print("EC: ", EC, " micro-siemens/cm")
    print("pH: ", pH)
    print("Water Temperature: ", Water_temperature, " Celsius")
    print("Water Level: ", round(Water_level, 2), " cm")
    print("---------- MODULE 2 -----------")
    print("Air Temperature: ", round(Air_temperature_2, 2), " Celsius")
    print("Humidity: ", Humidity_2, "%")
    print()
...
while True:
    ...
    try:
        ...
        if s_bytes:
            ...
            CO2 = float(lines[0])
            Air_temperature_1 = float(lines[1])
            Air_temperature_2 = float(lines[2])
            Humidity_1 = float(lines[3])
            Humidity_2 = float(lines[4])
