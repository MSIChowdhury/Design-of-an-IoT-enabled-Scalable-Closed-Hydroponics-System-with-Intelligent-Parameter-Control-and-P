...
def make_hydro_exp1_tables() -> None:
    ...
    for name in [
        ...
        "hydro_exp1_operating_tradeoff",
        "hydro_exp1_operating_tradeoff_selected",
        "hydro_exp1_evidence_status",
        ...
        "hydro_exp1_real_actuator_response",
        "hydro_exp1_real_actuator_response_summary",
        "hydro_exp1_reference_error_summary",
