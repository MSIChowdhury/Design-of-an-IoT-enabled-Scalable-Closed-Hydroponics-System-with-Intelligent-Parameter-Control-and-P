...
\item AASVR-R, a streaming validation, rectification, authorization, and actuator-response verification method with explicit trust scoring and bounded updates;
...
AASVR-R & 0.776 & 0.870 & 0.823 & 0.130 & \best{0.000} & \best{0.044} & \best{0.295} \\
...
\caption{Held-out hydroponic synthetic-fault balanced accuracy across methods. LOF is the strongest point detector; AASVR-R is close while using an interpretable response-aware supervisory structure.}
\label{fig:hydro_bar}
\end{figure}
...
\midrule
CO2 & \best{0.848} & \best{0.882} & \best{0.865} & 0.056 \\
Water temperature & 0.820 & 0.871 & 0.846 & 0.037 \\
Air temperature & 0.822 & 0.862 & 0.842 & 0.093 \\
pH & 0.781 & 0.868 & 0.825 & \best{0.019} \\
EC & 0.609 & 0.866 & 0.737 & \best{0.019} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Saturation & \best{1.000} & 0.864 & \best{0.932} & \best{0.000} \\
Dropout & \best{1.000} & 0.860 & 0.930 & \best{0.000} \\
Bias & 0.910 & 0.868 & 0.889 & \best{0.000} \\
Spike & 0.896 & \best{0.880} & 0.888 & 0.033 \\
Noise burst & 0.893 & 0.875 & 0.884 & 0.033 \\
Step & 0.874 & 0.878 & 0.876 & \best{0.000} \\
Multi-spike & 0.872 & 0.868 & 0.870 & \best{0.000} \\
...
Full AASVR-R & 0.776 & 0.870 & 0.823 & \best{0.044} \\
