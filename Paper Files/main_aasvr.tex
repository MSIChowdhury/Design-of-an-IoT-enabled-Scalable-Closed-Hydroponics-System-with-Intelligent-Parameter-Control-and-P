...
Process monitoring & EWMA, CUSUM, PCA-style residual monitoring & Shift or process-deviation detection & No \\
...
\begin{table}[!htbp]
\centering
\caption{Hydroponic synthetic-fault benchmark. The table reports leading methods by balanced accuracy on injected faults over the real hydroponic signal background. Bold entries mark the best value in each metric column among the displayed methods; lower is better for false actuation.}
\label{tab:hydro_synth}
\begin{tabular}{lrrrrr}
\toprule
Method & Recall & Specificity & Bal. acc. & FPR & False act. \\
\midrule
AASVR & 0.839 & 0.880 & \best{0.859} & 0.120 & \best{0.145} \\
...
One-Class SVM & \best{0.953} & 0.350 & 0.652 & 0.650 & 2.757 \\
Original & 0.161 & \best{0.998} & 0.579 & \best{0.002} & 3.060 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Dropout & \best{1.000} & \best{0.886} & \best{0.943} & \best{0.000} \\
Step & 0.890 & 0.881 & 0.886 & 0.167 \\
Spike & 0.883 & 0.878 & 0.880 & 0.200 \\
Bias & 0.876 & 0.877 & 0.876 & 0.200 \\
Multi-spike & 0.874 & 0.878 & 0.876 & \best{0.000} \\
...
\midrule
Full AASVR & \best{0.859} & 0.839 & 0.145 \\
No actuation confirmation & \best{0.859} & 0.839 & 0.569 \\
No cooldown & \best{0.859} & 0.839 & 0.269 \\
No robust MAD scale & 0.854 & \best{0.864} & \best{0.133} \\
...
\midrule
5.0 & 0.70 & 2 & \best{0.859} & \best{0.783} \\
5.0 & 0.70 & 1 & \best{0.859} & \best{0.783} \\
5.0 & 0.50 & 3 & \best{0.859} & \best{0.783} \\
5.0 & 0.85 & 2 & \best{0.859} & \best{0.783} \\
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.70\linewidth]{figure/hydro_exp1_ph_trace.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.70\linewidth]{figure/hydro_exp1_co2_trace.pdf}
...
\midrule
HAI & AASVR & 0.078 & \best{0.404} & 0.929 & \best{0.667} \\
HAI & Kalman & \best{0.136} & 0.312 & \best{0.971} & 0.641 \\
SKAB & AASVR & \best{0.379} & \best{0.975} & \best{0.358} & \best{0.666} \\
SKAB & Kalman & 0.376 & \best{0.975} & 0.349 & 0.662 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.72\linewidth]{figure/cross_dataset_rank_plot.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.78\linewidth]{figure/agronomic_parameters_violinplots_new.pdf}
